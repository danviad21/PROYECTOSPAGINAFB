<%-- 
    Document   : index
    Created on : 16/05/2020, 13:09:35
    Author     : danvi
--%>
...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="ProductoServlet">Suplementos</a>
